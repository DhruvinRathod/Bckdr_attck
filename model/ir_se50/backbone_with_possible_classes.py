...
class Backbone(Module):
    def __init__(self, num_layers, drop_ratio, mode='ir', classify=False, num_classes=None):
        ...
        self.output_layer = Sequential(OrderedDict([
            ("batchnorm",BatchNorm2d(512)),
            ("dropout",Dropout(drop_ratio)),
            ("flatten",Flatten()),
            ("linear",Linear(512 * 7 * 7, 512)),
            ("",BatchNorm1d(512))]))
        """
        modules = []
        for block in blocks:
